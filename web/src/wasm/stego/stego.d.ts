...
export function capacity(bmp_data: Uint8Array): number;

export function decode(bmp_data: Uint8Array): Uint8Array;

export function encode(bmp_data: Uint8Array, message: Uint8Array): Uint8Array;
